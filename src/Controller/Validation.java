...
public class Validation {
    ...
    public static String checkInputSemester() {
        while (true) {
            String result = checkInputString().toLowerCase();
            if (result.equals("fall") || result.equals("spring") || result.equals("summer")) {
                return result;
            }
            System.err.println("Please enter 'Fall', 'Spring', or 'Summer'.");
            System.out.print("Enter again: ");
        }
    }
